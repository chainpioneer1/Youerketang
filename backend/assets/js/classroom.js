...
$(function () {
    ...
    //     if ($(this).attr('item_type') == 'self') return;
    //     var id = $(this).attr('itemid');
    //     $(this).css({background: 'url(' + baseURL + 'assets/images/classroom/kuaile' + id + '_clicked.png)'});
    // })
    // $('.list_item').on('mouseout', function (object) {
    //     if ($(this).attr('item_type') == 'self') return;
    //     var id = $(this).attr('itemid');
    //     $(this).css({background: 'url(' + baseURL + 'assets/images/classroom/kuaile' + id + '.png)'});
    // })
