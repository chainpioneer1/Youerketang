...
<script>
    ...
    function update_item(self) {
        ...
        var msg_title = $('#item_update_modal').find('.modal-header h3');
        msg_title.html('<?= $this->lang->line('update_expand_course_information'); ?>');
    ...
    function update_perform(self) {
        ...
        fdata.append("icon_name", (package_name != '') ? (removeExtFromFilename(package_name) + '.' + icon_type) : icon_name);
        fdata.append("package_name", package_name);
        $.ajax({
            url: baseURL + "admin/courses/update_expand",
            type: "POST",
            data: fdata,
            contentType: false,
            cache: false,
    ...
    function publish_perform(self) {
        ...
        $.ajax({
            type: "post",
            url: baseURL + "admin/courses/publish_expand",
            dataType: "json",
    ...
    function delete_perform(self) {
        ...
        jQuery.ajax({
            type: "post",
            url: baseURL + "admin/courses/delete_expand",
            dataType: "json",
    ...
    function update_order(self, step) {
        ...
        $.ajax({
            type: "post",
            url: baseURL + "admin/courses/update_expand_order",
            dataType: "json",
