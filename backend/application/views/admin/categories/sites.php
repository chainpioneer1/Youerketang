...
<div class="scripts" hidden style="display: none;">
    ...
    <script>
        $(function () {
            $('a.nav-link[menu_id="20"]').addClass('menu-selected');
            searchConfig();
        })
...
//                    tbody.innerHTML = res.data;
        ...
        function addItem(self) {
            ...
            $('#edit-modal input[name="no"]').val(value3);
            $('#edit-modal input[name="title"]').val(value4);
...
//            $('div .img_preview[item_type="4"]').css({background: '#f0f0f0'});
        ...
        function editItem(self) {
            ...
            var value1 = '';
            var value2 = '';
            var value3 = trtag.cells[0].innerHTML;
            var value4 = trtag.cells[1].innerHTML;
