...
class Sites extends Admin_Controller
{
    ...
    function __construct()
    {
        ...
        $this->mainModel = $this->sites_m;
    }

    public function index()
    {
        $this->data['title'] = '课程管理';
        ...
        $ret = $this->paginationCompress('admin/sites/index', $cntPage, $perPage, 4);
        ...
        $this->data["subview"] = "admin/categories/sites";
