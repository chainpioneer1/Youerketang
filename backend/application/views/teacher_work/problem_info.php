...
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/frontend/teacher_work/teacher_work_problem_info.css') ?>">
<div class="bg" id="main-background-full"></div>
<div class="question_container" itemid="1">
    <div class="title_container question_title">
        <div class="test_time_container"></div>
    </div>
...
<script>
    console.log(<?php echo json_encode($problem_info);?>);
    var problemInfo = <?php echo json_encode($problem_info);?>;
</script>
<script src="<?= base_url('assets/js/teacher_work/teacher_work_problem_info.js') ?>" type="text/javascript"></script>