                ...
                <div class="portlet light bordered">
                    <div class="table-toolbar" style="margin-bottom: 0;">
                        ...
                        <form action="subwares" method="post" class="form-horizontal" id="sw_access_search_form">
                            <div class="form-group">
                                <label class="col-md-2 control-label"><?php echo $this->lang->line('SubwareName'); ?>
                                    :</label>
                                <div class="col-md-2" style="padding-left: 0;padding-right: 0;">
                                    <input type="text" class="form-control" name="sw_type_name_search" placeholder=""
                                           value="<?php echo $sw_type_name_value; ?>">
                                </div>
                                <label class="col-md-offset-1 col-md-1 control-label"><?php echo $this->lang->line('Time'); ?>
                                    :</label>
                                <div class="col-md-1">
                                    <input class="form-control form-control-inline input-small date-picker" size="20"
                                           type="text" name="startTime_search" value="<?php echo $startTime_value; ?>">
                                </div>
                                <label class="col-md-1 control-label"><?php echo $this->lang->line('To'); ?></label>
                                <div class="col-md-1" style="padding-left:0;">
                                    <input class="form-control form-control-inline input-small date-picker" size="20"
                                           type="text" name="endTime_search" value="<?php echo $endTime_value; ?>">
                                </div>
                                <div class="col-md-2" style="text-align: right">
                                    <div class="btn-group">
                                        <button class="btn  blue"><i
...
<?php foreach ($swAccessSets as $swAccess): ?>
    <script>
        var eachItem = {
            x: '<?php echo $swAccess['sw_type_name'];?>',
            value:<?php echo $swAccess['visit_num'];?>,
            fill: "#fcc",
            stroke: null
        };
        data.push(eachItem);
