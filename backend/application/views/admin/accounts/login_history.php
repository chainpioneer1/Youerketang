...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height: 1305px;">
        <h1 class="page-title"><?php echo $this->lang->line('panel_title_52'); ?>
            <small></small>
        </h1>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-7">
                                                <select class="form-control" id="sel1_search">
                                                    ...
                                                    <option value="1"><?php echo $this->lang->line('first_reg_time'); ?></option>
                                                    <option value="2"><?php echo $this->lang->line('latest_reg_time'); ?></option>
                                                    <option value="3"><?php echo $this->lang->line('reg_count'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="main_tbl">
                            <thead>
                            <tr>
                                <th><?php echo $this->lang->line('reg_history_number'); ?></th>
                                <th><?php echo $this->lang->line('first_reg_time'); ?></th>
                                <th><?php echo $this->lang->line('latest_reg_time'); ?></th>
                                <th hidden><?php echo $this->lang->line('reg_count'); ?></th>
                            </tr>
                            </thead>
...
<!-------Modal to Assign Role to admin ---------->
<script>
    $('a.nav-link[menu_id=52]').addClass('menu-selected');
...
//                executionPageNation();
    ...
    function search_action() {
        ...
        for (var i = 1; i < tr.length; i++) {
            ...
            var create_d = tr[i].getElementsByTagName("td")[0].innerHTML;
            var act_d = tr[i].getElementsByTagName("td")[0].innerHTML;
            if (act_d == '') act_d = '3000-01-01';
            create_d = Date.parse(create_d);
            act_d = Date.parse(act_d);
            if(cmpst>0) {
                tr[i].style.display = "";
            }else if (true || cmpst > 0) {
                if (txt1 != '' && tr[i].getElementsByTagName("td")[parseInt(txt1)].innerHTML.indexOf(keyword) > -1)
                    tr[i].style.display = "";
                else if (txt2 != '' && tr[i].getElementsByTagName("td")[0].innerHTML.toUpperCase() != txt2)
                    tr[i].style.display = "none";
                else if (txt3 != '' && tr[i].getElementsByTagName("td")[0].innerHTML.toUpperCase() != txt3)
                    tr[i].style.display = "none";
