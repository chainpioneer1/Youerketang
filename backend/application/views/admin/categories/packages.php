<?php
$ctrlRoot = 'admin/packages';
$category = '课次';
$mainModel = 'tbl_package';
?>
        ...
        <form class="form-horizontal" action="" id="add-submit-form" role="form"
            ...
            <div class="form-body">
                ...
                <div class="form-group" style="display: none!important;">
                    <label for="cwImageUpload" class=" col-md-4 control-label" style="text-align: center;">移动端封面图:</label>
                    <div class="col-md-7" style="padding-left: 0;">
                        <div class="fileinput fileinput-new" data-provides="fileinput"
                             style="background-color: #e0e1e1;position: relative">
                                <span class="btn btn-default btn-file">
...
<div class="scripts" hidden style="display: none;">
    ...
    <script>
        ...
        function searchConfig() {
            ...
            if (filterInfo['tbl_yekt_course.title']) $('input[name="search_keyword"]').val(filterInfo['tbl_yekt_course.title']);
            if (filterInfo[_mainObj+'.course_id']) $('select[name="search_course"]').val(filterInfo[_mainObj+'.course_id']);
        }
...
//            $('div .img_preview[item_type="4"]').css({background: '#f0f0f0'});
        ...
        function editItem(self) {
            ...
            var value1 = self.getAttribute('data-course-id');
