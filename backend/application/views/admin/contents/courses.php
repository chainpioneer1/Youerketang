<?php
$ctrlRoot = 'admin/courses';
$category = '素材';
$mainModel = 'tbl_yekt_courses';
?>
                        ...
                        <div class="row">
                            <form class="form-horizontal col-md-7" action="<?= base_url($ctrlRoot . '/index') ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-md-5 control-label">所属课次
                                                :</label>
                                            <div class="col-md-7">
                                                <select type="text" class="form-control"
                                                        name="search_course_cat1"></select>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <form class="form-horizontal" action="" id="add-submit-form" role="form"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7" style="padding-left: 0">
                        <select class="form-control" name="course_cat1_id" value=""></select>
                    </div>
                </div>
...
<div class="scripts" hidden style="display: none;">
    ...
    <input hidden class="courseCat1List" value='<?= json_encode($courseCat1List) ?>'>
    <input hidden class="filterInfo"
           value='<?= json_encode($this->session->userdata('filter') ? $this->session->userdata('filter') : array()) ?>'>
    <script>
        $(function () {
            $('a.nav-link[menu_id="30"]').addClass('menu-selected');
            searchConfig();
        })

        var courseList = JSON.parse($('.courseList').val());
        var courseCat1List = JSON.parse($('.courseCat1List').val());
        ...
        function searchConfig() {
            ...
            setTimeout(function () {
                if (filterInfo['tbl_package.id']) $('select[name="search_course_cat1"]').val(filterInfo['tbl_package.id']);
            }, 1);
        }
...
//                    tbody.innerHTML = res.data;
        ...
        function editItem(self) {
            ...
            var value4 = self.getAttribute('data-course_cat1_id');
