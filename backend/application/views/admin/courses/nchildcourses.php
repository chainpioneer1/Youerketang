                        ...
                        <div class="row">
                                ...
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-5 control-label"><?php echo $this->lang->line('ChildCourse'); ?>
                                                :</label>
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="nccs_name_search"
                                                       placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="nccs_keyword_search"
                                                       placeholder="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-7 visible-ie8 visible-ie9">
                                <div class="btn-group right-floated">
                                    <button class=" btn sbold green" id="add_new_nccs_btn">
                                        <i class="fa fa-plus"></i>&nbsp<?php echo $this->lang->line('AddNew'); ?>
                                    </button>
                                </div>
                            </div>
                            <!-------Table tool parts----------------->
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="nccsInfo_tbl">
                            ...
                            <tr>
                                ...
                                <th width="170px"><?php echo $this->lang->line('Operation'); ?></th>
                            </tr>
                            </thead>
...
<div id="add_nccs_modal" class="modal fade" tabindex="-1" data-width="750">
    ...
    <div class="modal-body">
        <form class="form-horizontal" enctype="multipart/form-data" action="" id="add_nccs_submit_form" role="form"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control input-inline" name="add_nccs_name" id="add_nccs_name"
                               value="">
                    </div>
...
<div id="edit_nccs_modal" class="modal fade" tabindex="-1" data-width="750">
    ...
    <div class="modal-body">
        <form class="form-horizontal" enctype="multipart/form-data" action="" id="edit_nccs_submit_form" role="form"
              method="post" accept-charset="utf-8">
            <div class="form-body">
                <div class="form-group">
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('ChildCourseName'); ?>
                        :</label>
                    <div class="col-md-4">
                        <label class="control-label" name="edit_nccs_name" id="edit_nccs_name">
                            <?php echo $this->lang->line('ChildCourseName'); ?>
                        </label>
                        <!--<input type="text" class="form-control input-inline" value="">-->
                    </div>
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('ParentCourseName'); ?>
                        :</label>
                    <div class="col-md-4">
                        <label class="control-label"
                               id="edit_cs_name" name="edit_cs_name">
                            <?php echo $this->lang->line('ParentCourseName'); ?>
                        </label>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('SerialNumber'); ?>
                        :</label>
                    <div class="col-md-4">
                        <label class="control-label"
                               id="edit_nccs_number" name="edit_nccs_number">
                            <?php echo $this->lang->line('SerialNumber'); ?>
                        </label>
                        <!--<select class="form-control" id="edit_school_type_name" name="edit_school_type_name">
                            <option><?php echo $this->lang->line('PrimarySchool'); ?></option>
                        </select>-->
                    </div>
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('SortOrder'); ?>
                        :</label>
                    <div class="col-md-3">
                        <input type="number" class="form-control" value="" min="0"
                               id="edit_nccs_sort_number" name="edit_nccs_sort_number">
                        <!--<div class="mt-radio-inline">
                            <label class="mt-radio mt-radio-outline">
                ...
                <div class="form-group visible-ie8 visible ie9">
                    <label for="cwImageUpload"
                           class="col-md-2 control-label"><?php echo $this->lang->line('CoursewareImage'); ?></label>
                    <div class="col-md-3">
                        <input type="file" id="edit_nccs_upload_img" name="edit_file_name"
    ...
    <div class="form-actions">
        <div class="form-group">
            <div class="col-md-11 " style="padding-bottom: 15px;text-align: -webkit-center;">
                <button type="submit" class="btn green right-floated"
                        id="edit_nccs_save"><?php echo $this->lang->line('Save'); ?></button>
            </div>
        </div>
    </div>
    </form>
...
<script>
    ...
    $('#newchildcourse_menu').addClass('menu-selected');
    ...
    $('#edit_nccs_submit_form').submit(function (e) {
        ...
        var nccs_num = parseInt($('#edit_nccs_sort_number').val());
        if (nccs_num < 0) {
            alert("请输入正确的排序号(正整数).");
            return;
        }
    ...
    function edit_nccs(self) {
        ...
        var nccsSort = self.getAttribute('nccs_sort');
        ...
        $('#edit_nccs_name').html(nccs_name);
        $('#edit_cs_name').html(trtag.cells[2].innerHTML);
        $('#edit_nccs_number').html(trtag.cells[0].innerHTML);
        $('#edit_nccs_sort_number').val(nccsSort);
