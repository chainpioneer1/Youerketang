        ...
        Highlighter.prototype = {
            ...
            serialize: function(options) {
                ...
                forEach(highlights, function(highlight) {
                    ...
                    var elems = highlight.getHighlightElements();
                    var comment = $(elems[0]).attr('data-comment');
            ...
            deserialize: function(serialized) {
                ...
                var classApplier, highlight, characterRange, containerElementId, containerElement, comment;
                ...
                for (var i = serializedHighlights.length, parts; i-- > 0; ) {
                    ...
                    highlight = new Highlight(this.doc, characterRange, classApplier, this.converter, parseInt(parts[2]), containerElementId, comment);
                    highlight.apply();
                    var elems = highlight.getHighlightElements();
                    $(elems[0]).attr('data-comment', comment);
