...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height: 1305px;">
        <h1 class="page-title"><?php echo $this->lang->line('panel_title_22'); ?>
            <small></small>
        </h1>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-5 control-label"><?php echo $this->lang->line('search_condition'); ?>
                                                :</label>
                                            <div class="col-md-7">
...
<script>
    ...
    function search_action(keyword, txt1, txt2, txt3) {
        ...
        for (i = 1; i < tr.length; i++) {
            ...
            var cmpst = 0;
            if (txt1 === "0"){
                for (j = 5; j < 8; j++)//5 is search filed count
                {
                ...
                var td = tr[i].getElementsByTagName("td")[parseInt(txt1)];
                if (td) {
                    var txt = td.innerHTML.toUpperCase();
                    if (txt != '' && txt.indexOf(keyword) > -1) cmpst++;
                }
            ...
            if (cmpst > 0) {
               /* if (txt1 != '' && tr[i].getElementsByTagName("td")[4].innerHTML.toUpperCase() != txt1)
                ...
                else*/ if (txt2 != '' && tr[i].getElementsByTagName("td")[6].innerHTML.toUpperCase() != txt2)
                    tr[i].style.display = "none";
                else if (txt3 != '' && tr[i].getElementsByTagName("td")[7].innerHTML.toUpperCase() != txt3)
                    tr[i].style.display = "none";
                else
                    tr[i].style.display = "";
            }
