...
class Courses extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($_POST) {
            ...
            $_POST['search_course_cat1'] != '' && $filter['tbl_package.id'] = $_POST['search_course_cat1'];
        ...
        $ret = $this->paginationCompress('admin/courses/index', $cntPage, $perPage, 4);
        ...
        $this->data["courseCat1List"] = $this->package_m->getItems();
...
//                '</td>';
            ...
            $output .= '<button'
                ...
                . ' data-course_cat1_id = "' . $unit->package_id . '" '
    ...
    public function updateItem()
    {
        ...
        if ($_POST) {
            ...
            $no = str_replace(' ', '', $no);
            $title = $_POST['title'];
            $course_cat1_id = $_POST['course_cat1_id'];
