...
$(function () {
    ...
    $('.list_item').on('mouseover', function (object) {
        var id = $(this).attr('itemid');
        $(this).css({background: 'url(' + baseURL + '/assets/images/resource/education/kuaile' + id + '_clicked.png)'});
    })
    $('.list_item').on('mouseout', function (object) {
        var id = $(this).attr('itemid');
        $(this).css({background: 'url(' + baseURL + '/assets/images/resource/education/kuaile' + id + '.png)'});
    })
